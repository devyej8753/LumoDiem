				...
				<div class="row d-flex">
					<div class="col-xl-8 py-5 px-md-5">
						<div class="row pt-md-4">
							<!-- 페이지 제목  -->
							<h3 style="text-align: center; margin-bottom: 20px;">신고된 클래스
								목록</h3>


							<!-- 신고된 클래스 목록 출력 부분 -->
							<div class="report_klass_list"
								style="width: 100%; max-width: 100%; margin: 20px auto; border: 1px solid #ddd; border-radius: 10px; padding: 10px;">
								<form>
									<table class="report_klass_list"
										style="width: 100%; border-collapse: separate; border-spacing: 0 5px; text-align: center; border: 1px solid #ddd;">

										<thead
											style="border-bottom: 2px solid #aaa; background-color: #D1B5E0;">
											<tr
												...
												<th style="width: 60px; padding: 8px; text-align: center;">신고
													사유</th>
											</tr>
										</thead>
										<tbody>
												...
												<c:when test="${not empty resultList }">
													<c:forEach var="list" varStatus="vs" items="${resultList }">
														<tr data-klass-no="${list.klassNo }"
															style="background-color: #E8DAEF; border-bottom: 1px solid #ddd;">
								...
								<c:if test="${not empty paging}">
									...
									<c:forEach var="i" begin="${paging.pageBarStart }"
										...
										<a class="pagingNumber" style="color: #724AA9;"
											href="/reportKlass?nowPage=${i}">${i}</a>
									</c:forEach>


									<c:if test="${paging.next }">
										<a style="color: #724AA9;"
											href="/reportKlass?nowPage=${paging.pageBarEnd + 1}">&raquo;</a>
									</c:if>
							...
							<div style="text-align: center; margin-top: 20px;">
								<form action="<c:url value='/reportKlass'/>"
									id="search_report_klass" method="post"
